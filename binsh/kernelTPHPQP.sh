...
echo $JAVA_HOME/bin/java $JAVA_OPTIONS -cp $CLASSPATH com.ntnu.laika.distributed.tp.TPKernelHPQP $@
$JAVA_HOME/bin/java $JAVA_OPTIONS -cp $CLASSPATH com.ntnu.laika.distributed.tp.TPKernelHPQP $@
