...
echo java  $JAVA_OPTIONS -cp $CLASSPATH com.ntnu.laika.distributed.tp.TPKernelHPQP $@
java $JAVA_OPTIONS -cp $CLASSPATH com.ntnu.laika.distributed.tp.TPKernelHPQP $@
