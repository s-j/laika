...
import com.ntnu.laika.distributed.tp.queryprocessing.TPPipelinedQueryProcessorHPQP;
 ...
 * @version $Id $.
 */
public class TPWorkerQueryProcessingHPQP  implements Closeable, MessageHandler{
	protected TPKernelHPQP kernel;
	...
	public TPWorkerQueryProcessingHPQP(TPKernelHPQP kernel){
		this.kernel = kernel;
		...
		processor = new TPPipelinedQueryProcessorHPQP(index, server, kernel.workpool);
		terminated = false;
	}
