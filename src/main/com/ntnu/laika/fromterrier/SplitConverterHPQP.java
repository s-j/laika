 ...
 * @version $Id $.
 */
public class SplitConverterHPQP {
	...
	public SplitConverterHPQP(String lexmap, String src, String mainpath, int numnodes) throws IOException, InterruptedException{
		LexMapping map = new LexMapping(lexmap);
		...
		int rr = 0;
		int NODES = GlobalLexiconEntry.MAX_NODES_SUPPORTED;
		for (int i=0; i<numterms; i++){
			...
			if (bv == null) {
				bv = new BitVector(NODES,rr);
				if (++rr >= NODES) rr = 0;
			}
			for (int destnode : bv.getIDs()){
	...
	public static void main(String args[]) throws IOException, InterruptedException{
		String mapping = "/home/simonj/index/8BIN/";
		String idxsrc = "/home/simonj/laikatest/";
		String idxdst = "/home/simonj/index/BIN/";
		int numnodes = 8;
		
		//idx, lex and properties
		System.out.println("splitting index: creating subdirectories, inverted and lexicon files");
		new SplitConverterHPQP(mapping, idxsrc, idxdst, 8);
